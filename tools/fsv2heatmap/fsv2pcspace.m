...
list_of_patients = {'PY13N001';'PY04N007';'PY04N012';'PY04N013';'PY04N015';'PY05N005';'PY11N003';'PY11N006';...
                    'PY12N005';'PY12N008';'PY12N010';'PY12N012';'PY13N003';'PY13N011';'PY14N004';...
                    'PY14N005'};

%% fsv2heatmap content repurposed
...
% This is 'PY13N001', the only patient in the list that wasn't used in the retro study.
cellfind = @(string)(@(cell_contents)(strcmp(string,cell_contents)));
test_patient_id = find(cellfun(cellfind('PY13N001'),all_patient_ids), 1);
