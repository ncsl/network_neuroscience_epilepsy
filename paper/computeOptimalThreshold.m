...
FAILURE_UMMC = NR_UMMC;

SUCCESS = {SUCCESS_JHUOLD, SUCCESS_JHU, SUCCESS_NIH, SUCCESS_UMMC};
FAILURE = {FAILURE_OLDJHU, FAILURE_JHU, FAILURE_NIH,FAILURE_UMMC};
NR = {NR_JHU, NR_UMMC};
%% Set Working Dirs
homeDir = '/Users/adam2392/Dropbox/EZTrack/PAPER/Data/';
workDir = '/home/WIN/ali39/Dropbox/EZTrack/PAPER/Data/';
...
%         outcome = patData.Outcome;
    ...
    toSaveFigFile = fullfile(figDir, strcat(CENTERS{iCenter}, '_success_doavsthreshold'));
...
%         outcome = patData.Outcome;
    ...
    xlabel('Thresholds on Degree of Agreement');
    ylabel('Degree of Agreement (Jaccard Index)');
    titleStr = {[CENTERS{iCenter}, ' FAilure Patients']};
    title(titleStr);
    ax.FontSize = FONTSIZE;
    ...
    toSaveFigFile = fullfile(figDir, strcat(CENTERS{iCenter}, '_failure_doavsthreshold'));
    print(toSaveFigFile, '-dpng', '-r0')
end
