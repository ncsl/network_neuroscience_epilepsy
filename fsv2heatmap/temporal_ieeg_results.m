function csv_file = temporal_ieeg_results(eztrack_home, test_patient_id, labels_filename, start_mark, end_mark)
    ...
    [patients_in_region, patient_info] = reference_data(eztrack_home, temporal_patients, test_patient_id, labels_filename, start_mark, end_mark);
