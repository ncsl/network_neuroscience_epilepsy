function [patients_in_region, patient_info] = reference_data(eztrack_home, patients_in_region, test_patient_id, labels_filename, included_channels, start_mark, end_mark)
    ...
    if (~any(find(ismember(patients_in_region, test_patient_id))))
        ...
        if start_mark < 60
            fprintf('There is something wrong with this file! The start mark is less than 60 seconds.\n');
        end
    end
